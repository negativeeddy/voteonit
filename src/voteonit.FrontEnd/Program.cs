using QRCoder;
using VoteOnIt.FrontEnd.Components;
using VoteOnIt.FrontEnd;
...
builder.Services.AddHttpClient<PollServiceApi>(client => client.BaseAddress = new("http://apiservice"));
